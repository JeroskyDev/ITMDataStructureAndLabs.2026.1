...
do
{
    ...
    {
        Console.WriteLine($"{yearString} NO es un número, intente de nuevo");
        return;
    }
    ...
    if (yearInt % 4 == 0)
    {
        ...
        if (yearInt % 100 == 0)
        {
            ...
            if (yearInt % 400 == 0)
            {
                Console.WriteLine($"El año {yearInt} SI {message} un año bisiesto.");
            }
            else //is not a leap year because it doesn´t check all of the conditions.
            {
                Console.WriteLine($"El año {yearInt} NO {message} un año bisiesto.");
            }
        }
